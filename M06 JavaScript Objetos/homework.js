...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
  var nuevoNumero= objetoMisterioso.numeroMisterioso * 5;
   return nuevoNumero;
}
...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   var probando= objetoUsuario.hasOwnProperty("email")
...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   var propy= objeto.hasOwnProperty(propiedad);
if (propy === true) {
return true;
} else {
return false
